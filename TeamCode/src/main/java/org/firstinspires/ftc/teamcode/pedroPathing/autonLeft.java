...
@Autonomous(name = "auton LEft side", group = "Autonomous")
@Configurable // Panels
public class autonLeft extends OpMode {
  ...
  public void init() {
    ...
    follower.setStartingPose(new Pose(60, 11, Math.toRadians(315)));
  ...
  public static class Paths {
    ...
    public Paths(Follower follower) {
      Path1 = follower
        .pathBuilder()
        .addPath(
          new BezierLine(new Pose(59.664, 11.888), new Pose(35.888, 107.888))
        )
